...
class MyFrame( wx.Frame ):
    ...
    def __init__(self, parent):
        ...
        self.m_textCtrl6_1=wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 500, 180 ),
                                        wx.TE_MULTILINE )
        gbSizer6.Add( self.m_textCtrl6_1, wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )

        self.m_textCtrl6_2=wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 500, 180 ), wx.TE_MULTILINE )
        ...
        self.m_textCtrl9_1=wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 500, 30 ), 0 )
        gbSizer9.Add( self.m_textCtrl9_1, wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )

        self.m_textCtrl9_2=wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 500, 30 ), 0 )
